...
Dự án PKKQ ở `D:\ProjectAI\PKKQ\` là cho khách hàng quốc phòng — tế nhị về bảo mật/phân loại. Đưa vào tài liệu giảng dạy cho học viên là không phù hợp.

- **Case study #3** dùng tên generic: **"ERP doanh nghiệp đa phân hệ"** (KHÔNG nêu PKKQ, KHÔNG nêu Bộ Quốc phòng)
- Mô tả module chung: Kho, Tài chính, Sản xuất, Bảo trì, Hợp đồng, Mua hàng, Portal — không nêu rõ ngành/khách hàng
- User sẽ clone 1 bản PKKQ phiên bản dân sự (tránh BQP). Khi user gửi đường dẫn mới, cập nhật chi tiết case (screenshot, prototype, tên cụ thể) ở slide 9 buổi 1 + folder `giao-trinh/case-studies/03-erp-doanh-nghiep/`.
- Trong khi chờ: giữ placeholder "Prototype thực tế sẽ giới thiệu chi tiết ở các buổi sau".
...
3. **ERP doanh nghiệp đa phân hệ** (placeholder, chờ user clone)
   - Multi-module: Kho, Tài chính, Sản xuất, Bảo trì, Hợp đồng…
   - Sẽ có prototype thực ở các buổi 5+
